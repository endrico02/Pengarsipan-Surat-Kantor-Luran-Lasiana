                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Pengunjung Hari Ini
                            </h6>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Pengunjung Minggu Ini</h6>
                        </div>
                        {{-- <div class="ms-auto mt-md-3 mt-lg-0">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Pengunjung Bulan Ini</h6>
                        </div>
                        {{-- <div class="ms-auto mt-md-3 mt-lg-0">
            ...
            <div class="card ">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            <h2 class="text-dark mb-1 font-weight-medium">0</h2>
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Pengunjung Tahun Ini</h6>
                        </div>
                        {{-- <div class="ms-auto mt-md-3 mt-lg-0">
