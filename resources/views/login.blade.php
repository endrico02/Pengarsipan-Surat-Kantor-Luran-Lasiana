...
<body>
    <div class="main-wrapper">
        ...
        style="background:url(../assets/images/big/auth-bg.jpg) no-repeat center center;">
            ...
            <div class="auth-box row col-lg-3">
                <div class="col-lg-12 col-md-6 bg-white">
                    <div class="p-3">
                        <div class="text-center">
                            <img src="logo.png" width="100px" alt="wrapkit">
                        </div>
                        <h2 class="mt-3 text-center">Sign In</h2>
                        <p class="text-center">SISTEM INFORMASI PENGARSIPAN KELURAHAN LASIANA</p>
                        <form action="actionlogin" method="POST" class="mt-4">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        <label class="form-label text-dark" for="uname">Email</label>
                                        <input name="email" class="form-control" id="uname" type="email"
